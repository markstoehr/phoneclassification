...
\begin{verbatim}
python local/TestSVMBernoulli.py --data $train_examples\
    --templates $templates\
    --svm_labels_fl $svm_labels_fl\
    --svm_component_ids_fl $svm_component_ids_fl\
    --svm_fl_prefices_fl $svm_fl_prefices_fl  
